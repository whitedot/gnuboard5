...
if ($is_admin) {
    echo '<div><a href="'.G5_ADMIN_URL.'/shop_admin/itemform.php?w=u&amp;it_id='.$it_id.'" title="상품 관리"><span>상품 관리</span><i></i></a></div>';
}
?>
...
?>
    <ul>
        <li><a href="#sit_inf" <?php if ($anc_id == 'inf') echo ''; ?>>상품정보</a></li>
        <li><a href="#sit_use" <?php if ($anc_id == 'use') echo ''; ?>>사용후기 <span><?php echo $item_use_count; ?></span></a></li>
        <li><a href="#sit_qa" <?php if ($anc_id == 'qa') echo ''; ?>>상품문의 <span><?php echo $item_qa_count; ?></span></a></li>
        <?php if ($default['de_baesong_content']) { ?><li><a href="#sit_dvr" <?php if ($anc_id == 'dvr') echo ''; ?>>배송정보</a></li><?php } ?>
        <?php if ($default['de_change_content']) { ?><li><a href="#sit_ex" <?php if ($anc_id == 'ex') echo ''; ?>>교환정보</a></li><?php } ?>
    </ul>
<?php
}
