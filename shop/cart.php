...
<div id="sod_bsk">
    ...
    <div>
        ...
        <tr>
            <th scope="col">
                ...
                <label for="ct_all"><span></span><b>상품 전체</b></label>
            </th>
            <th scope="col">상품명</th>
            <th scope="col">총수량</th>
            <th scope="col">판매가</th>
        ...
        for ($i=0; $row=sql_fetch_array($result); $i++)
        {
            ...
            if($it_options) {
                $mod_options = '<div><button type="button" class="mod_options">선택사항수정</button></div>';
        ...
        <tr>
            <td>
            	...
            	<label for="ct_chk_<?php echo $i; ?>"><span></span><b>상품</b></label>
            </td> 
            
            <td>
                <div><a href="<?php echo shop_item_url($row['it_id']); ?>"><?php echo $image; ?></a></div>
                <div>
            ...
            <td><span id="sell_price_<?php echo $i; ?>"><?php echo number_format($sell_price); ?></span></td>
        </tr>
    ...
    <div id="sod_bsk_act">
        <?php if ($i == 0) { ?>
        <a href="<?php echo G5_SHOP_URL; ?>/">쇼핑 계속하기</a>
        <?php } else { ?>
        <input type="hidden" name="url" value="./orderform.php">
        <input type="hidden" name="records" value="<?php echo $i; ?>">
        <input type="hidden" name="act" value="">
        <a href="<?php echo shop_category_url($continue_ca_id); ?>">쇼핑 계속하기</a>
        <button type="button" onclick="return form_check('buy');">주문하기</button>
