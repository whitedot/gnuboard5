    ...
    <section id="sod_fin_list">
        ...
        <div>
            ...
            <tr>
                ...
                <td headers="th_itname" colspan="7"><a href="<?php echo shop_item_url($row['it_id']); ?>"><?php echo $row['it_name']; ?></a></td>
            </tr>
            <?php } ?>
            <tr>
                <td headers="th_itopt"><?php echo get_text($opt['ct_option']); ?></td>
                <td headers="th_itqty"><?php echo number_format($opt['ct_qty']); ?></td>
                <td headers="th_itprice"><?php echo number_format($opt_price); ?></td>
                <td headers="th_itsum"><?php echo number_format($sell_price); ?></td>
                <td headers="th_itpt"><?php echo number_format($point); ?></td>
                <td headers="th_itsd"><?php echo $ct_send_cost; ?></td>
                <td headers="th_itst"><?php echo $opt['ct_status']; ?></td>
            </tr>
            <?php
                    $tot_point       += $point;
        ...
        <section id="sod_fin_tot">
            ...
            <ul>
                ...
                <li id="alrdy">
                    ...
                    <div>
                        <p><span><i aria-hidden="true"></i> 포인트 결제</span><?php echo number_format($od['od_receipt_point']); ?> 점</p>
                        <p><span><i aria-hidden="true"></i> 실결제</span><?php echo number_format($od['od_receipt_price']); ?> 원</p>
                    </div>
                    <?php } ?>
                </li>
            </ul>
