...
<div id="bo_gall" style="width:<?php echo $width; ?>">
    ...
    <div id="gall_allchk" class="all_chk chk_box">
        ...
        <label for="chkall">
            <span></span>
            <b class="sr-only">현재 페이지 게시물 </b> 전체선택
        </label>
    </div>
    <?php } ?>
        ...
        <li class="<?php echo implode(' ', $classes); ?>">
            <div class="gall_box">
                ...
                <div class="gall_con">
                    ...
                    <div class="gall_info">
                        <span class="sr-only">작성자 </span><?php echo $list[$i]['name'] ?>
                        <span class="gall_date"><span class="sr-only">작성일 </span><i class="fa fa-clock-o" aria-hidden="true"></i> <?php echo $list[$i]['datetime2'] ?></span>
                        <span class="gall_view"><span class="sr-only">조회 </span><i class="fa fa-eye" aria-hidden="true"></i> <?php echo $list[$i]['wr_hit'] ?></span>
                    </div>
                    <div class="gall_option">
                      <?php if ($is_good) { ?><span class="sr-only">추천</span><strong><i class="fa fa-thumbs-o-up" aria-hidden="true"></i> <?php echo $list[$i]['wr_good'] ?></strong><?php } ?>
                        <?php if ($is_nogood) { ?><span class="sr-only">비추천</span><strong><i class="fa fa-thumbs-o-down" aria-hidden="true"></i> <?php echo $list[$i]['wr_nogood'] ?></strong><?php } ?>           
                    </div>
                </div>
            </div>
        </li>
