                ...
                <div>
                    ...
                    <div>
                        ...
                        <a href="<?php echo $list[$i]['href'] ?>">
                         ...
                         <span><?php echo utf8_strcut(strip_tags($list[$i]['wr_content']), 68, '..'); ?></span>
                    </div>

                    <div>
                        <span>작성자 </span><?php echo $list[$i]['name'] ?>
                        <span><span>작성일 </span><i aria-hidden="true"></i> <?php echo $list[$i]['datetime2'] ?></span>
                        <span><span>조회 </span><i aria-hidden="true"></i> <?php echo $list[$i]['wr_hit'] ?></span>
                    </div>
                    <div>
                      <?php if ($is_good) { ?><span>추천</span><strong><i aria-hidden="true"></i> <?php echo $list[$i]['wr_good'] ?></strong><?php } ?>
                        <?php if ($is_nogood) { ?><span>비추천</span><strong><i aria-hidden="true"></i> <?php echo $list[$i]['wr_nogood'] ?></strong><?php } ?>           
                    </div>
                </div>
            </div>
        </li>
