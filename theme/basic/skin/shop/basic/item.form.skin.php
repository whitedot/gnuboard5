...
<div id="sit_ov_from">
	...
	<div id="sit_ov_wrap">
	    ...
	    <div id="sit_pvi">
	        ...
	        ?>
	        <a href="<?php echo G5_SHOP_URL; ?>/largeimage.php?it_id=<?php echo $it['it_id']; ?>&amp;no=1" target="_blank" id="popup_item_image" class="popup_item_image"><i aria-hidden="true"></i><span>확대보기</span></a>
	        </div>
	        <?php
	        // 썸네일
	        $thumb1 = true;
	        ...
	        if($total_count > 0) {
	            ...
	            foreach($thumbnails as $val) {
	                $thumb_count++;
	                $sit_pvi_last ='';
	                if ($thumb_count % 5 == 0) $sit_pvi_last = '';
	                    echo '<li '.$sit_pvi_last.'>';
	                    echo '<a href="'.G5_SHOP_URL.'/largeimage.php?it_id='.$it['it_id'].'&amp;no='.$thumb_count.'" target="_blank" class="popup_item_image img_thumb">'.$val.'<span> '.$thumb_count.'번째 이미지 새창</span></a>';
	                    echo '</li>';
	            }
	            echo '</ul>';
	        }
	    ...
	    <!-- 상품 요약정보 및 구매 시작 { -->
	    <section id="sit_ov">
	        <h2 id="sit_title"><?php echo stripslashes($it['it_name']); ?> <span>요약정보 및 구매</span></h2>
	        ...
	        <div id="sit_star_sns">
	            ...
	            <span>별<?php echo $star_score?>개</span> 
	            <?php } ?>
	            
	            <span>사용후기 <?php echo $it['it_use_cnt']; ?> 개</span>
	            
	            <div id="sit_btn_opt">
	            	<span id="btn_wish"><i aria-hidden="true"></i><span>위시리스트</span><span><?php echo get_wishlist_count_by_item($it['it_id']); ?></span></span>
	            	<button type="button" class="btn_sns_share"><i aria-hidden="true"></i><span>sns 공유</span></button>
	            	<div class="sns_area">
	            		<?php echo $sns_share_links; ?>
	            		<a href="javascript:popup_item_recommend('<?php echo $it['it_id']; ?>');" id="sit_btn_rec"><i aria-hidden="true"></i><span>추천하기</span></a>
	            	</div>
	        	</div>
	        </div>
	        <script>
	        ...
	        <div id="sit_ov_btn">
	            ...
	            <?php } ?>
	            <a href="javascript:item_wish(document.fitem, '<?php echo $it['it_id']; ?>');"><i aria-hidden="true"></i><span>위시리스트</span></a>
    ...
    <div id="sit_siblings">
	    ...
	    if ($prev_href || $next_href) {
	        ...
	        echo '<span>이 분류에 등록된 다른 상품이 없습니다.</span>';
	    }
	    ?>
	</div>   
    <!-- } 다른 상품 보기 끝 -->
