...
<div id="ssch">
    ...
    <div id="ssch_frm">
	        ...
	        <div>
	            ...
	            <label for="ssch_qfrom">최소 가격</label>
	            <input type="text" name="qfrom" value="<?php echo $qfrom; ?>" id="ssch_qfrom" size="10"> 원 ~
	            <label for="ssch_qto">최대 가격</label>
    ...
    <!-- 검색결과 시작 { -->
        ...
        {
            $i = 0;
            $error = '<p>'.$list_file.' 파일을 찾을 수 없습니다.<br>관리자에게 알려주시면 감사하겠습니다.</p>';
        }
