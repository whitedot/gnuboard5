...
<?php if ($is_admin) {  //관리자이면 ?>
    <div class="sit_admin"><a href="<?php echo G5_ADMIN_URL; ?>/shop_admin/configform.php#anc_scf_etc" class="btn_admin btn"><i class="fa fa-cog fa-spin fa-fw"></i><span class="sr-only">검색 설정</span></a></div>
<?php } ?>
<!-- 검색 시작 { -->
<div id="ssch">
    ...
    <div id="ssch_frm">
		<div class="ssch_frm_inner">
	        ...
	        <div class="ssch_scharea">
	            <label for="ssch_q" class="sr-only" >검색어</label>
	        ...
	        <div class="ssch_option chk_box">
	            <strong class="sr-only">검색범위</strong>
	            ...
	            <strong class="sr-only">상품가격 (원)</strong>
	            <label for="ssch_qfrom" class="sr-only">최소 가격</label>
	            <input type="text" name="qfrom" value="<?php echo $qfrom; ?>" id="ssch_qfrom" class="ssch_input" size="10"> 원 ~
	            <label for="ssch_qto" class="sr-only">최대 가격</label>
