...
if (!isset($g5['content_table'])) {
    die('<meta charset="utf-8">관리자 모드에서 내용 관리를 먼저 확인해 주세요.');
}
...
// Force tag filtering for managed content.
...
if ($is_admin) {
    echo run_replace(
        'content_admin_button_html',
        '<div><a href="'.G5_ADMIN_URL.'/contentform.php?w=u&amp;co_id='.$co_id.'"><span>내용 수정</span><i></i></a></div>',
        $co
    );
}
