        ...
        <div class="card">
            <div class="grid grid-cols-1 gap-4">
                                    <div class="grid grid-cols-1 lg:grid-cols-4 gap-3 lg:gap-6 border-b border-dashed border-default-300 pb-4">
                                            ...
                                            <div class="lg:col-span-1"><input type="text" name="cf_delay_sec" value="<?php echo (int) $config['cf_delay_sec'] ?>" id="cf_delay_sec" required class="required numeric frm_input form-input" size="3"> 초 지난후 가능                    </div>
                            ...
                            <select name="cf_link_target" id="cf_link_target" class="form-select">
                                ...
                                <option value="_new" <?php echo get_selected($config['cf_link_target'], '_new') ?>>_new</option>
                                    ...
                                    <div class="grid grid-cols-1 lg:grid-cols-4 gap-3 lg:gap-6 border-b border-dashed border-default-300 pb-4">
                                            ...
                                            <div class="lg:col-span-1"><input type="text" name="cf_read_point" value="<?php echo (int) $config['cf_read_point'] ?>" id="cf_read_point" required class="required frm_input form-input" size="3"> 점                    </div>
                                            <div class="lg:col-span-1"><label for="cf_write_point" class="form-label py-2 mb-0!">글쓰기 포인트</label>                    </div>
                                            <div class="lg:col-span-1"><input type="text" name="cf_write_point" value="<?php echo (int) $config['cf_write_point'] ?>" id="cf_write_point" required class="required frm_input form-input" size="3"> 점                    </div>
                                    </div>
                                    <div class="grid grid-cols-1 lg:grid-cols-4 gap-3 lg:gap-6 border-b border-dashed border-default-300 pb-4">
                                            <div class="lg:col-span-1"><label for="cf_comment_point" class="form-label py-2 mb-0!">댓글쓰기 포인트</label>                    </div>
                                            <div class="lg:col-span-1"><input type="text" name="cf_comment_point" value="<?php echo (int) $config['cf_comment_point'] ?>" id="cf_comment_point" required class="required frm_input form-input" size="3"> 점                    </div>
                                            <div class="lg:col-span-1"><label for="cf_download_point" class="form-label py-2 mb-0!">다운로드 포인트</label>                    </div>
                                            <div class="lg:col-span-1"><input type="text" name="cf_download_point" value="<?php echo (int) $config['cf_download_point'] ?>" id="cf_download_point" required class="required frm_input form-input" size="3"> 점                    </div>
                                    </div>
                                    <div class="grid grid-cols-1 lg:grid-cols-4 gap-3 lg:gap-6 border-b border-dashed border-default-300 pb-4">
                                            <div class="lg:col-span-1"><label for="cf_search_part" class="form-label py-2 mb-0!">검색 단위</label>                    </div>
                                            <div class="lg:col-span-3"><input type="text" name="cf_search_part" value="<?php echo (int) $config['cf_search_part'] ?>" id="cf_search_part" class="frm_input form-input" size="4"> 건 단위로 검색                    </div>
                                    </div>
                                    <div class="grid grid-cols-1 lg:grid-cols-4 gap-3 lg:gap-6 border-b border-dashed border-default-300 pb-4">
                            ...
                            <input type="text" name="cf_image_extension" value="<?php echo get_sanitize_input($config['cf_image_extension']); ?>" id="cf_image_extension" class="frm_input form-input" size="70">
                                            </div>
                                    </div>
                                    <div class="grid grid-cols-1 lg:grid-cols-4 gap-3 lg:gap-6 border-b border-dashed border-default-300 pb-4">
                            ...
                            <input type="text" name="cf_flash_extension" value="<?php echo get_sanitize_input($config['cf_flash_extension']); ?>" id="cf_flash_extension" class="frm_input form-input" size="70">
                                            </div>
                                    </div>
                                    <div class="grid grid-cols-1 lg:grid-cols-4 gap-3 lg:gap-6 border-b border-dashed border-default-300 pb-4">
                            ...
                            <input type="text" name="cf_movie_extension" value="<?php echo get_sanitize_input($config['cf_movie_extension']); ?>" id="cf_movie_extension" class="frm_input form-input" size="70">
                                            </div>
                                    </div>
                                    <div class="grid grid-cols-1 lg:grid-cols-4 gap-3 lg:gap-6 border-b border-dashed border-default-300 pb-4">
