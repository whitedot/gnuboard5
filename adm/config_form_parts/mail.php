        ...
        <div class="cf-grid">
            <div class="cf-row">
                ...
                <div class="cf-field">
                    ...
                    <label for="cf_email_use" class="cf-check">
            ...
            <div class="cf-row">
                ...
                <div class="cf-field">
                    ...
                    <label for="cf_use_email_certify" class="cf-check">
            ...
            <div class="cf-row">
                ...
                <div class="cf-field">
                    ...
                    <label for="cf_formmail_is_member" class="cf-check">
        ...
        <div class="cf-grid">
            <div class="cf-row">
                ...
                <div class="cf-field">
                    ...
                    <label for="cf_email_wr_super_admin" class="cf-check">
            ...
            <div class="cf-row">
                ...
                <div class="cf-field">
                    ...
                    <label for="cf_email_wr_group_admin" class="cf-check">
            ...
            <div class="cf-row">
                ...
                <div class="cf-field">
                    ...
                    <label for="cf_email_wr_board_admin" class="cf-check">
            ...
            <div class="cf-row">
                ...
                <div class="cf-field">
                    ...
                    <label for="cf_email_wr_write" class="cf-check">
            ...
            <div class="cf-row">
                ...
                <div class="cf-field">
                    ...
                    <label for="cf_email_wr_comment_all" class="cf-check">
    ...
    <div class="card-body">
        <div class="cf-grid">
            <div class="cf-row">
                ...
                <div class="cf-field">
                    <?php echo help('최고관리자에게 메일을 발송합니다.') ?>
                    <label for="cf_email_mb_super_admin" class="cf-check">
            ...
            <div class="cf-row">
                ...
                <div class="cf-field">
                    ...
                    <label for="cf_email_mb_member" class="cf-check">
    ...
    <div class="card-body">
        <div class="cf-grid">
            <div class="cf-row">
                ...
                <div class="cf-field">
                    <?php echo help('최고관리자에게 메일을 발송합니다.') ?>
                    <label for="cf_email_po_super_admin" class="cf-check">
