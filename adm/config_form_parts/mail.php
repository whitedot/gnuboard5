        ...
        <div class="af-grid">
            <div class="af-row">
                ...
                <div class="af-field">
                    ...
                    <label for="cf_email_use" class="af-check">
            ...
            <div class="af-row">
                ...
                <div class="af-field">
                    ...
                    <label for="cf_use_email_certify" class="af-check">
            ...
            <div class="af-row">
                ...
                <div class="af-field">
                    ...
                    <label for="cf_formmail_is_member" class="af-check">
        ...
        <div class="af-grid">
            <div class="af-row">
                ...
                <div class="af-field">
                    ...
                    <label for="cf_email_wr_super_admin" class="af-check">
            ...
            <div class="af-row">
                ...
                <div class="af-field">
                    ...
                    <label for="cf_email_wr_group_admin" class="af-check">
            ...
            <div class="af-row">
                ...
                <div class="af-field">
                    ...
                    <label for="cf_email_wr_board_admin" class="af-check">
            ...
            <div class="af-row">
                ...
                <div class="af-field">
                    ...
                    <label for="cf_email_wr_write" class="af-check">
            ...
            <div class="af-row">
                ...
                <div class="af-field">
                    ...
                    <label for="cf_email_wr_comment_all" class="af-check">
    ...
    <div class="card-body">
        <div class="af-grid">
            <div class="af-row">
                ...
                <div class="af-field">
                    <?php echo help('최고관리자에게 메일을 발송합니다.') ?>
                    <label for="cf_email_mb_super_admin" class="af-check">
            ...
            <div class="af-row">
                ...
                <div class="af-field">
                    ...
                    <label for="cf_email_mb_member" class="af-check">
    ...
    <div class="card-body">
        <div class="af-grid">
            <div class="af-row">
                ...
                <div class="af-field">
                    <?php echo help('최고관리자에게 메일을 발송합니다.') ?>
                    <label for="cf_email_po_super_admin" class="af-check">
