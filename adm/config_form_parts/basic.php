        ...
        <div class="card">
            <div class="grid grid-cols-1 gap-4">
                                    ...
                                    <div class="grid grid-cols-1 lg:grid-cols-4 gap-3 lg:gap-6 border-b border-dashed border-default-300 pb-4">
                                            ...
                                            <div class="lg:col-span-3"><?php echo get_member_id_select('cf_admin', 10, $config['cf_admin'], 'required') ?>                    </div>
                                    </div>
                                    <div class="grid grid-cols-1 lg:grid-cols-4 gap-3 lg:gap-6 border-b border-dashed border-default-300 pb-4">
                            ...
                            <input type="text" name="cf_admin_email_name" value="<?php echo get_sanitize_input($config['cf_admin_email_name']); ?>" id="cf_admin_email_name" required class="required form-input" size="40">
                                    ...
                                    <div class="grid grid-cols-1 lg:grid-cols-4 gap-3 lg:gap-6 border-b border-dashed border-default-300 pb-4">
                                            <div class="lg:col-span-1"><label for="cf_use_point" class="form-label py-2 mb-0!">포인트 사용</label>                    </div>
                                            <div class="lg:col-span-3"><input type="checkbox" name="cf_use_point" value="1" id="cf_use_point" <?php echo $config['cf_use_point'] ? 'checked' : ''; ?>> 사용                    </div>
                                    </div>
                                    <div class="grid grid-cols-1 lg:grid-cols-4 gap-3 lg:gap-6 border-b border-dashed border-default-300 pb-4">
                            ...
                            <?php echo get_skin_select('new', 'cf_new_skin', 'cf_new_skin', $config['cf_new_skin'], 'required'); ?>
                                            ...
                                            <div class="lg:col-span-1"><label for="cf_search_skin" class="form-label py-2 mb-0!">검색 스킨<strong class="sr-only">필수</strong></label>                    </div>
                                            <div class="lg:col-span-1">
                            <?php echo get_skin_select('search', 'cf_search_skin', 'cf_search_skin', $config['cf_search_skin'], 'required'); ?>
                                            </div>
                                    </div>
                                    <div class="grid grid-cols-1 lg:grid-cols-4 gap-3 lg:gap-6 border-b border-dashed border-default-300 pb-4">
                                            <div class="lg:col-span-1"><label for="cf_connect_skin" class="form-label py-2 mb-0!">접속자 스킨<strong class="sr-only">필수</strong></label>                    </div>
                                            <div class="lg:col-span-1">
                            <?php echo get_skin_select('connect', 'cf_connect_skin', 'cf_connect_skin', $config['cf_connect_skin'], 'required'); ?>
                                            </div>
                                            <div class="lg:col-span-1"><label for="cf_faq_skin" class="form-label py-2 mb-0!">FAQ 스킨<strong class="sr-only">필수</strong></label>                    </div>
                                            <div class="lg:col-span-1">
                            <?php echo get_skin_select('faq', 'cf_faq_skin', 'cf_faq_skin', $config['cf_faq_skin'], 'required'); ?>
                                            </div>
                                    </div>
                                    <div class="grid grid-cols-1 lg:grid-cols-4 gap-3 lg:gap-6 border-b border-dashed border-default-300 pb-4">
                                            <div class="lg:col-span-1"><label for="cf_editor" class="form-label py-2 mb-0!">에디터 선택</label>                    </div>
                                            <div class="lg:col-span-3">
                            ...
                            <select name="cf_editor" id="cf_editor" class="form-select">
                                ...
                                ?>
                                    ...
                                    <div class="grid grid-cols-1 lg:grid-cols-4 gap-3 lg:gap-6 border-b border-dashed border-default-300 pb-4">
                                            <div class="lg:col-span-1"><label for="cf_captcha" class="form-label py-2 mb-0!">캡챠 선택<strong class="sr-only">필수</strong></label>                    </div>
                                            <div class="lg:col-span-3">
                            ...
                            <select name="cf_captcha" id="cf_captcha" required class="required form-select">
                                ...
                                <option value="recaptcha_inv" <?php echo get_selected($config['cf_captcha'], 'recaptcha_inv'); ?>>Invisible reCAPTCHA</option>
                                    ...
                                    <div class="grid grid-cols-1 lg:grid-cols-4 gap-3 lg:gap-6 border-b border-dashed border-default-300 pb-4">
                                            <div class="lg:col-span-1"><label for="cf_captcha_mp3" class="form-label py-2 mb-0!">음성캡챠 선택<strong class="sr-only">필수</strong></label>                    </div>
                                            <div class="lg:col-span-3">
                            <?php echo help('kcaptcha 사용시 ' . str_replace(array('recaptcha_inv', 'recaptcha'), 'kcaptcha', G5_CAPTCHA_URL) . '/mp3 밑의 음성 폴더를 선택합니다.') ?>
                            <select name="cf_captcha_mp3" id="cf_captcha_mp3" required class="required form-select">
                                <?php
                            ...
                            <input type="text" name="cf_recaptcha_secret_key" value="<?php echo get_sanitize_input($config['cf_recaptcha_secret_key']); ?>" id="cf_recaptcha_secret_key" class="form-input" size="52">
                                    ...
                                    <div class="grid grid-cols-1 lg:grid-cols-4 gap-3 lg:gap-6 border-b border-dashed border-default-300 pb-4">
                                            <div class="lg:col-span-1"><label for="cf_use_copy_log" class="form-label py-2 mb-0!">복사, 이동시 로그</label>                    </div>
                                            <div class="lg:col-span-3">
                            ...
                            <input type="text" name="cf_point_term" value="<?php echo (int) $config['cf_point_term']; ?>" id="cf_point_term" required class="required form-input" size="5"> 일
                                    ...
                                    <div class="grid grid-cols-1 lg:grid-cols-4 gap-3 lg:gap-6 border-b border-dashed border-default-300 pb-4">
                                            <div class="lg:col-span-1"><label for="cf_possible_ip" class="form-label py-2 mb-0!">접근가능 IP</label>                    </div>
                                            <div class="lg:col-span-1">
                            <?php echo help('입력된 IP의 컴퓨터만 접근할 수 있습니다.<br>123.123.+ 도 입력 가능. (엔터로 구분)') ?>
                            <textarea name="cf_possible_ip" id="cf_possible_ip" class="form-textarea min-h-24 w-full"><?php echo get_sanitize_input($config['cf_possible_ip']); ?></textarea>
                                            </div>
                                            <div class="lg:col-span-1"><label for="cf_intercept_ip" class="form-label py-2 mb-0!">접근차단 IP</label>                    </div>
                                            <div class="lg:col-span-1">
                            <?php echo help('입력된 IP의 컴퓨터는 접근할 수 없음.<br>123.123.+ 도 입력 가능. (엔터로 구분)') ?>
                            <textarea name="cf_intercept_ip" id="cf_intercept_ip" class="form-textarea min-h-24 w-full"><?php echo get_sanitize_input($config['cf_intercept_ip']); ?></textarea>
                                            </div>
                                    </div>
                                    <div class="grid grid-cols-1 lg:grid-cols-4 gap-3 lg:gap-6 border-b border-dashed border-default-300 pb-4">
                                            <div class="lg:col-span-1"><label for="cf_analytics" class="form-label py-2 mb-0!">방문자분석 스크립트</label>                    </div>
                                            <div class="lg:col-span-3">
                            <?php echo help('방문자분석 스크립트 코드를 입력합니다. 예) 구글 애널리틱스<br>관리자 페이지에서는 이 코드를 사용하지 않습니다.'); ?>
                            <textarea name="cf_analytics" id="cf_analytics" class="form-textarea min-h-24 w-full"><?php echo get_text($config['cf_analytics']); ?></textarea>
                                            </div>
                                    </div>
                                    <div class="grid grid-cols-1 lg:grid-cols-4 gap-3 lg:gap-6 border-b border-dashed border-default-300 pb-4">
                                            <div class="lg:col-span-1"><label for="cf_add_meta" class="form-label py-2 mb-0!">추가 메타태그</label>                    </div>
                                            <div class="lg:col-span-3">
                            <?php echo help('추가로 사용하실 meta 태그를 입력합니다.<br>관리자 페이지에서는 이 코드를 사용하지 않습니다.'); ?>
                            <textarea name="cf_add_meta" id="cf_add_meta" class="form-textarea min-h-24 w-full"><?php echo get_text($config['cf_add_meta']); ?></textarea>
                                            </div>
                                    </div>
                                    <div class="grid grid-cols-1 lg:grid-cols-4 gap-3 lg:gap-6 border-b border-dashed border-default-300 pb-4">
                                            <div class="lg:col-span-1"><label for="cf_syndi_token" class="form-label py-2 mb-0!">네이버 신디케이션 연동키</label>                    </div>
                                            <div class="lg:col-span-3">
