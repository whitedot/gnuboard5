    ...
    <div class="card-body">
        ...
        <div class="cf-grid">
            ...
            <div class="cf-row">
                ...
                <div class="cf-field">
                    <div class="cf-inline">
                        <label for="cf_use_homepage" class="cf-check">
                        ...
                        <label for="cf_req_homepage" class="cf-check">
            ...
            <div class="cf-row">
                ...
                <div class="cf-field">
                    <div class="cf-inline">
                        <label for="cf_use_signature" class="cf-check">
                        ...
                        <label for="cf_req_signature" class="cf-check">
            ...
            <div class="cf-row">
                ...
                <div class="cf-field">
                    <div class="cf-inline">
                        <label for="cf_use_profile" class="cf-check">
                        ...
                        <label for="cf_req_profile" class="cf-check">
            ...
            <div class="cf-row">
                ...
                <div class="cf-field">
                    <label for="cf_use_recommend" class="cf-check">
            ...
            <div class="cf-row">
                ...
                <div class="cf-field">
                    ...
                    <label for="cf_use_promotion" class="cf-check">
