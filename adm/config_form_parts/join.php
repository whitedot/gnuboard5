    <section id="anc_cf_join">
        ...
        <?php echo $pg_anchor ?>
            ...
            <div>
                                            ...
                                            <label for="cf_member_skin">회원 스킨<strong>필수</strong></label>                    
                            ...
                            <select name="cf_use_member_icon" id="cf_use_member_icon">
                                ...
                                <option value="2" <?php echo get_selected($config['cf_use_member_icon'], '2') ?>>아이콘+이름 표시
                                            ...
                                            <label for="cf_icon_level">회원 아이콘, 이미지 업로드 권한</label>                    
                            ...
                            픽셀 이하
                                    ...
                                    <div>
                                            <label for="cf_member_img_size">회원이미지 용량</label>                    
                            ...
                            픽셀 이하
                                    ...
                                    <div>
                                            <label for="cf_use_recommend">추천인제도 사용</label>                    
                            ...
                            <textarea name="cf_prohibit_email" id="cf_prohibit_email" rows="5"><?php echo get_sanitize_input($config['cf_prohibit_email']); ?></textarea>
                                    ...
                                    <div>
                                            ...
                                            <textarea id="cf_privacy" name="cf_privacy" rows="10"><?php echo html_purifier($config['cf_privacy']); ?></textarea>                    
                                    </div>
                                    <div>
                                            <label for="cf_use_promotion">회원가입 약관 동의에<br>광고성 정보 수신 동의 표시 여부</label>                    
                                            <div>
