    ...
    <input type="hidden" name="token" value="">
        ...
        <div class="ui-form-grid">
            <div class="ui-form-caption"><?php echo $g5['title']; ?></div>
                ...
                <div class="ui-form-row">
                    <div class="ui-form-label"><label for="nw_device">접속기기</label></div>
                    <div class="ui-form-field">
                ...
                <div class="ui-form-row">
                    <div class="ui-form-label"><label for="nw_disable_hours">시간<strong> 필수</strong></label></div>
                    <div class="ui-form-field">
                        <?php echo help("고객이 다시 보지 않음을 선택할 시 몇 시간동안 팝업레이어를 보여주지 않을지 설정합니다."); ?>
                        <input type="text" name="nw_disable_hours" value="<?php echo $nw['nw_disable_hours']; ?>" id="nw_disable_hours" required class="required" size="5"> 시간
                    </div>
                </div>
                <div class="ui-form-row">
                    <div class="ui-form-label"><label for="nw_begin_time">시작일시<strong> 필수</strong></label></div>
                    <div class="ui-form-field">
                        <input type="text" name="nw_begin_time" value="<?php echo $nw['nw_begin_time']; ?>" id="nw_begin_time" required class="required" size="21" maxlength="19">
                ...
                <div class="ui-form-row">
                    <div class="ui-form-label"><label for="nw_end_time">종료일시<strong> 필수</strong></label></div>
                    <div class="ui-form-field">
                        <input type="text" name="nw_end_time" value="<?php echo $nw['nw_end_time']; ?>" id="nw_end_time" required class="required" size="21" maxlength="19">
                ...
                <div class="ui-form-row">
                    <div class="ui-form-label"><label for="nw_left">팝업레이어 좌측 위치<strong> 필수</strong></label></div>
                    <div class="ui-form-field">
                        <input type="text" name="nw_left" value="<?php echo $nw['nw_left']; ?>" id="nw_left" required class="required" size="5"> px
                    </div>
                </div>
                <div class="ui-form-row">
                    <div class="ui-form-label"><label for="nw_top">팝업레이어 상단 위치<strong> 필수</strong></label></div>
                    <div class="ui-form-field">
                        <input type="text" name="nw_top" value="<?php echo $nw['nw_top']; ?>" id="nw_top" required class="required" size="5"> px
                    </div>
                </div>
                <div class="ui-form-row">
                    <div class="ui-form-label"><label for="nw_width">팝업레이어 넓이<strong> 필수</strong></label></div>
                    <div class="ui-form-field">
                        <input type="text" name="nw_width" value="<?php echo $nw['nw_width'] ?>" id="nw_width" required class="required" size="5"> px
                    </div>
                </div>
                <div class="ui-form-row">
                    <div class="ui-form-label"><label for="nw_height">팝업레이어 높이<strong> 필수</strong></label></div>
                    <div class="ui-form-field">
                        <input type="text" name="nw_height" value="<?php echo $nw['nw_height'] ?>" id="nw_height" required class="required" size="5"> px
                    </div>
                </div>
                <div class="ui-form-row">
                    <div class="ui-form-label"><label for="nw_subject">팝업 제목<strong> 필수</strong></label></div>
                    <div class="ui-form-field">
                        <input type="text" name="nw_subject" value="<?php echo get_sanitize_input($nw['nw_subject']); ?>" id="nw_subject" required class="required" size="80">
                    </div>
                </div>
                <div class="ui-form-row">
                    <div class="ui-form-label"><label for="nw_content">내용</label></div>
                    <div class="ui-form-field"><?php echo editor_html('nw_content', get_text(html_purifier($nw['nw_content']), 0)); ?></div>
                </div>
