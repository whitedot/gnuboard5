    ...
    <div>
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <th scope="row"><label for="nw_disable_hours">시간<strong> 필수</strong></label></th>
                    <td>
                ...
                <tr>
                    <th scope="row"><label for="nw_begin_time">시작일시<strong> 필수</strong></label></th>
                    <td>
                ...
                <tr>
                    <th scope="row"><label for="nw_end_time">종료일시<strong> 필수</strong></label></th>
                    <td>
