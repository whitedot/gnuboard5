...
<script>
    var g5_admin_csrf_token_key = "<?php echo $admin_head_view['admin_csrf_token_key']; ?>";
</script>

<div id="to_content"><a href="#container">본문 바로가기</a></div>

<header id="hd">
    <h1 class="sr-only"><?php echo $admin_head_view['admin_site_title']; ?></h1>

    <nav id="gnb" class="<?php echo $admin_head_view['adm_menu_cookie']['gnb']; ?>" aria-label="관리자 메뉴">
        ...
        <h2>
            <a href="<?php echo correct_goto_url(G5_ADMIN_URL); ?>">
                ...
                <span><?php echo $admin_head_view['admin_site_title']; ?></span>
            </a>
            <button type="button" id="btn_gnb" class="<?php echo $admin_head_view['adm_menu_cookie']['btn_gnb']; ?>" aria-label="사이드바 축소/확장" aria-pressed="false">
                <span aria-hidden="true">
                    <svg class="admin-shell-control-icon" focusable="false" viewBox="0 0 24 24">
            ...
            <div class="gnb_menu_scroll" id="gnbMenuScroll">
                <ul class="admin-nav-list" id="adminNavList">
                    <?php foreach ($admin_head_view['admin_navigation_items'] as $nav_item) { ?>
                        <li class="admin-nav-item<?php echo $nav_item['item_class']; ?>">
                            <button type="button" class="admin-nav-trigger" title="<?php echo $nav_item['title']; ?>" aria-expanded="<?php echo $nav_item['aria_expanded']; ?>">
                            ...
                            <div class="admin-nav-panel<?php echo $nav_item['panel_class']; ?>">
                                <ul class="admin-nav-sub-list">
                                    <?php foreach ($nav_item['sub_items'] as $sub_item) { ?>
                                        <li class="admin-nav-sub-item<?php echo $sub_item['item_class']; ?>" data-menu="<?php echo $sub_item['menu_code']; ?>">
        ...
        <div class="gnb_profile">
            <div class="gnb_profile_avatar"><?php echo $admin_head_view['admin_profile_initial']; ?></div>
            <div class="gnb_profile_meta">
                <strong><?php echo $admin_head_view['admin_profile_name'] ?: $admin_head_view['admin_profile_id']; ?></strong>
                <span><?php echo $admin_head_view['admin_profile_mail']; ?></span>
            </div>
            <a class="gnb_profile_logout" href="<?php echo $admin_head_view['admin_logout_url']; ?>" title="로그아웃" aria-label="로그아웃">
...
<div id="wrapper">
        ...
        <div class="hd_top_right">
            <div id="tnb">
                <ul>
                    ...
                    <li class="tnb_li">
                        <a class="tnb_icon_btn" href="<?php echo $admin_head_view['admin_home_url']; ?>" target="_blank" title="메인" aria-label="메인">
                            <svg class="admin-shell-control-icon" aria-hidden="true" focusable="false" viewBox="0 0 24 24">
                    ...
                    <li class="tnb_li relative">
                        ...
                        <ul class="tnb_mb_area hidden">
                            <li><a href="<?php echo $admin_head_view['admin_profile_manage_url']; ?>">관리자정보</a></li>
                            <li id="tnb_logout"><a href="<?php echo $admin_head_view['admin_logout_url']; ?>">로그아웃</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
    ...
    <div id="container" class="<?php echo $admin_head_view['admin_container_class_attr']; ?>">
        <h1 id="container_title"><?php echo $g5['title']; ?></h1>
        <p id="container_subtitle"><?php echo $admin_head_view['admin_page_subtitle_text']; ?></p>
