...
<div>
    ...
    <tbody>
    <tr>
        <th scope="row"><label for="bg_no">그룹 <strong> 필수</strong></label></th>
        <td>
    ...
    <tr>
        <th scope="row"><label for="bk_name">이름<strong> 필수</strong></label></th>
        <td><input type="text" name="bk_name" id="bk_name" maxlength="50" value="<?php echo get_sanitize_input($write['bk_name']); ?>" required class="required"></td>
    </tr>
    <tr>
        <th scope="row"><label for="bk_hp">휴대폰번호<strong> 필수</strong></label></th>
        <td>
            <input type="text" name="bk_hp" id="bk_hp" value="<?php echo $write['bk_hp']?>" required class="required">
