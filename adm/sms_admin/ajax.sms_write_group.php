...
<div class="table-card table-shell card">
    ...
    <tr>
        ...
        <td class="cell-mngsmall"><button type="button" class="btn-inline" onclick="sms_obj.group_add(1, '<?php echo $no_group['bg_name']?>', '<?php echo number_format($no_group['bg_receipt'])?>')">추가</button></td>
    </tr>
    <?php
    $line = 1;
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td class="cell-mngsmall"><button type="button" class="btn-inline" onclick="sms_obj.group_add(<?php echo $group[$i]['bg_no']?>, '<?php echo $group[$i]['bg_name']?>', '<?php echo number_format($group[$i]['bg_receipt'])?>')">추가</button></td>
    </tr>
    <?php } ?>
    </tbody>
    </table>
