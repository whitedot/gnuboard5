...
<form name="search_form" id="search_form" action=<?php echo $_SERVER['SCRIPT_NAME'];?> method="get">
...
<div>
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td><?php echo date('Y-m-d H:i', strtotime($res['wr_datetime']))?></td>
        <td><?php echo $res['wr_booking']!='0000-00-00 00:00:00'?"<span title='{$res['wr_booking']}'>예약</span>":'';?></td>
        ...
        <td><?php echo $dupli_count;?></td>
        <td><?php echo number_format($res['wr_re_total'])?></td>
        <td>
