...
$type = $_POST['type'];
$arr_type = array('board', 'conf_skin', 'conf_member', 'shop_skin', 'shop_pc_index', 'shop_etc', 'shop_event', 'shop_category');
...
if($type == 'board') {
    ...
    $keys = run_replace('theme_config_load_keys', array('cf_new_skin', 'cf_search_skin', 'cf_connect_skin', 'cf_faq_skin'), $type);
    ...
    $keys = run_replace('theme_config_load_keys', array('de_shop_skin'), $type);
    ...
    $keys = run_replace('theme_config_load_keys', array('de_rel_list_use', 'de_rel_list_skin', 'de_rel_list_mod', 'de_rel_img_width', 'de_rel_img_height', 'de_search_list_skin', 'de_search_list_mod', 'de_search_list_row', 'de_search_img_width', 'de_search_img_height', 'de_mimg_width', 'de_mimg_height', 'de_listtype_list_mod', 'de_listtype_list_row'), $type);
    ...
    $keys = run_replace('theme_config_load_keys', array('ev_skin', 'ev_img_width', 'ev_img_height', 'ev_list_mod', 'ev_list_row'), $type);
    ...
    $keys = run_replace('theme_config_load_keys', array('ca_skin', 'ca_img_width', 'ca_img_height', 'ca_list_mod', 'ca_list_row'), $type);
