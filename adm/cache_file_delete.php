...
$cnt = 0;
echo '<div class="card p-4 mb-base"><ul class="session_del">' . PHP_EOL;
...
echo '<div class="hint-text"><p><strong>최신글 캐시파일 ' . $cnt . '건 삭제 완료됐습니다.</strong><br>프로그램의 실행을 끝마치셔도 좋습니다.</p></div>' . PHP_EOL;
?>
