...
$content = conv_content($se['ma_content'], 1) . "<hr size=0><p><span>▶ 더 이상 정보 수신을 원치 않으시면 [<a href='" . G5_MEMBER_URL . "/email_stop.php?mb_id=***&amp;mb_md5=***' target='_blank'>수신거부</a>] 해 주십시오.</span></p>";
?>
