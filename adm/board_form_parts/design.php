<section id="anc_bo_design">
    ...
    <div>
        ...
        <tbody>
            <tr>
            <th scope="row"><label for="bo_skin">스킨 디렉토리<strong>필수</strong></label></th>
            <td>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="bo_include_head" value="<?php echo get_sanitize_input($board['bo_include_head']); ?>" id="bo_include_head" size="50">
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="bo_include_tail" value="<?php echo get_sanitize_input($board['bo_include_tail']); ?>" id="bo_include_tail" size="50">
            </td>
            <td>
        ...
        <tr>
            <th scope="row"><label for="bo_subject_len">제목 길이<strong>필수</strong></label></th>
            <td>
                <?php echo help('목록에서의 제목 글자수. 잘리는 글은 … 로 표시') ?>
                <input type="text" name="bo_subject_len" value="<?php echo $board['bo_subject_len'] ?>" id="bo_subject_len" required class="required" size="4">
            </td>
            <td>
        ...
        <tr>
            <th scope="row"><label for="bo_gallery_cols">갤러리 이미지 수<strong>필수</strong></label></th>
            <td>
                <?php echo help('갤러리 형식의 게시판 목록에서 이미지를 한줄에 몇장씩 보여 줄 것인지를 설정하는 값') ?>
                <input type="text" name="bo_gallery_cols" value="<?php echo $board['bo_gallery_cols'] ?>" id="bo_gallery_cols" required class="required" size="4">
            </td>
            <td>
        ...
        <tr>
            <th scope="row"><label for="bo_gallery_width">갤러리 이미지 폭<strong>필수</strong></label></th>
            <td>
                <?php echo help('갤러리 형식의 게시판 목록에서 썸네일 이미지의 폭을 설정하는 값') ?>
                <input type="text" name="bo_gallery_width" value="<?php echo $board['bo_gallery_width'] ?>" id="bo_gallery_width" required class="required" size="4">
            </td>
            <td>
        ...
        <tr>
            <th scope="row"><label for="bo_gallery_height">갤러리 이미지 높이<strong>필수</strong></label></th>
            <td>
                <?php echo help('갤러리 형식의 게시판 목록에서 썸네일 이미지의 높이를 설정하는 값') ?>
                <input type="text" name="bo_gallery_height" value="<?php echo $board['bo_gallery_height'] ?>" id="bo_gallery_height" required class="required" size="4">
            </td>
            <td>
        ...
        <tr>
            <th scope="row"><label for="bo_table_width">게시판 폭<strong>필수</strong></label></th>
            <td>
                <?php echo help('100 이하는 %') ?>
                <input type="text" name="bo_table_width" value="<?php echo $board['bo_table_width'] ?>" id="bo_table_width" required class="required" size="4">
            </td>
            <td>
        ...
        <tr>
            <th scope="row"><label for="bo_image_width">이미지 폭 크기<strong>필수</strong></label></th>
            <td>
                <?php echo help('게시판에서 출력되는 이미지의 폭 크기') ?>
                <input type="text" name="bo_image_width" value="<?php echo $board['bo_image_width'] ?>" id="bo_image_width" required class="required" size="4"> 픽셀
            </td>
            <td>
        ...
        <tr>
            <th scope="row"><label for="bo_new">새글 아이콘<strong>필수</strong></label></th>
            <td>
                <?php echo help('글 입력후 new 이미지를 출력하는 시간. 0을 입력하시면 아이콘을 출력하지 않습니다.') ?>
                <input type="text" name="bo_new" value="<?php echo $board['bo_new'] ?>" id="bo_new" required class="required" size="4">
            </td>
            <td>
        ...
        <tr>
            <th scope="row"><label for="bo_hot">인기글 아이콘<strong>필수</strong></label></th>
            <td>
                <?php echo help('조회수가 설정값 이상이면 hot 이미지 출력. 0을 입력하시면 아이콘을 출력하지 않습니다.') ?>
                <input type="text" name="bo_hot" value="<?php echo $board['bo_hot'] ?>" id="bo_hot" required class="required" size="4">
            </td>
            <td>
