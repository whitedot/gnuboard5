<section id="anc_bo_point">
    ...
    <div>
        ...
        <tr>
            <th scope="row"><label for="bo_read_point">글읽기 포인트<strong>필수</strong></label></th>
            <td>
                <input type="text" name="bo_read_point" value="<?php echo $board['bo_read_point'] ?>" id="bo_read_point" required class="required" size="5">
            </td>
            <td>
        ...
        <tr>
            <th scope="row"><label for="bo_write_point">글쓰기 포인트<strong>필수</strong></label></th>
            <td>
                <input type="text" name="bo_write_point" value="<?php echo $board['bo_write_point'] ?>" id="bo_write_point" required class="required" size="5">
            </td>
            <td>
        ...
        <tr>
            <th scope="row"><label for="bo_comment_point">댓글쓰기 포인트<strong>필수</strong></label></th>
            <td>
                <input type="text" name="bo_comment_point" value="<?php echo $board['bo_comment_point'] ?>" id="bo_comment_point" required class="required" size="5">
            </td>
            <td>
        ...
        <tr>
            <th scope="row"><label for="bo_download_point">다운로드 포인트<strong>필수</strong></label></th>
            <td>
                <input type="text" name="bo_download_point" value="<?php echo $board['bo_download_point'] ?>" id="bo_download_point" required class="required" size="5">
            </td>
            <td>
