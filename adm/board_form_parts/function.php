<section id="anc_bo_function">
    <h2 class="section-title">게시판 기능 설정</h2>
    <?php echo $pg_anchor ?>
    ...
    <div class="form-card table-shell">
        ...
        <tr>
            ...
            <td>
                ...
                댓글 <input type="text" name="bo_count_modify" value="<?php echo $board['bo_count_modify'] ?>" id="bo_count_modify" required class="required numeric form-input" size="3">개 이상 달리면 수정불가
            </td>
        ...
        <tr>
            ...
            <td>
                댓글 <input type="text" name="bo_count_delete" value="<?php echo $board['bo_count_delete'] ?>" id="bo_count_delete" required class="required numeric form-input" size="3">개 이상 달리면 삭제불가
            </td>
            <td class="cell-grpset">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="bo_upload_count" value="<?php echo $board['bo_upload_count'] ?>" id="bo_upload_count" required class="required numeric form-input" size="4">
            </td>
            <td class="cell-grpset">
        ...
        <tr>
            ...
            <td>
                ...
                업로드 파일 한개당 <input type="text" name="bo_upload_size" value="<?php echo $board['bo_upload_size'] ?>" id="bo_upload_size" required class="required numeric form-input"  size="10"> bytes 이하
            </td>
            <td class="cell-grpset">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="bo_write_min" value="<?php echo $board['bo_write_min'] ?>" id="bo_write_min" class="numeric form-input" size="4">
            </td>
            <td class="cell-grpset">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="bo_write_max" value="<?php echo $board['bo_write_max'] ?>" id="bo_write_max" class="numeric form-input" size="4">
            </td>
            <td class="cell-grpset">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="bo_comment_min" value="<?php echo $board['bo_comment_min'] ?>" id="bo_comment_min" class="numeric form-input" size="4">
            </td>
            <td class="cell-grpset">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="bo_comment_max" value="<?php echo $board['bo_comment_max'] ?>" id="bo_comment_max" class="numeric form-input" size="4">
            </td>
            <td class="cell-grpset">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="bo_order" value="<?php echo $board['bo_order'] ?>" id="bo_order" class="form-input" size="4">
            </td>
            <td class="cell-grpset">
