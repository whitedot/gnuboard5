<section id="anc_bo_function">
    ...
    <?php echo $pg_anchor ?>
        ...
        <tbody>
        <tr>
            <th scope="row"><label for="bo_count_modify">원글 수정 불가<strong>필수</strong></label></th>
            <td>
                 <?php echo help('댓글의 수가 설정 수 이상이면 원글을 수정할 수 없습니다. 0으로 설정하시면 댓글 수에 관계없이 수정할 수있습니다.'); ?>
                댓글 <input type="text" name="bo_count_modify" value="<?php echo $board['bo_count_modify'] ?>" id="bo_count_modify" required class="required" size="3">개 이상 달리면 수정불가
            </td>
            <td>
        ...
        <tr>
            <th scope="row"><label for="bo_count_delete">원글 삭제 불가<strong>필수</strong></label></th>
            <td>
                댓글 <input type="text" name="bo_count_delete" value="<?php echo $board['bo_count_delete'] ?>" id="bo_count_delete" required class="required" size="3">개 이상 달리면 삭제불가
            </td>
            <td>
        ...
        <tr>
            <th scope="row"><label for="bo_upload_count">파일 업로드 개수<strong>필수</strong></label></th>
            <td>
                <?php echo help('게시물 한건당 업로드 할 수 있는 파일의 최대 개수 (0 은 파일첨부 사용하지 않음)') ?>
                <input type="text" name="bo_upload_count" value="<?php echo $board['bo_upload_count'] ?>" id="bo_upload_count" required class="required" size="4">
            </td>
            <td>
        ...
        <tr>
            <th scope="row"><label for="bo_upload_size">파일 업로드 용량<strong>필수</strong></label></th>
            <td>
                <?php echo help('최대 '.ini_get("upload_max_filesize").' 이하 업로드 가능, 1 MB = 1,048,576 bytes') ?>
                업로드 파일 한개당 <input type="text" name="bo_upload_size" value="<?php echo $board['bo_upload_size'] ?>" id="bo_upload_size" required class="required"  size="10"> bytes 이하
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="bo_write_min" value="<?php echo $board['bo_write_min'] ?>" id="bo_write_min" size="4">
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="bo_write_max" value="<?php echo $board['bo_write_max'] ?>" id="bo_write_max" size="4">
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="bo_comment_min" value="<?php echo $board['bo_comment_min'] ?>" id="bo_comment_min" size="4">
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="bo_comment_max" value="<?php echo $board['bo_comment_max'] ?>" id="bo_comment_max" size="4">
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="bo_order" value="<?php echo $board['bo_order'] ?>" id="bo_order" size="4">
            </td>
            <td>
