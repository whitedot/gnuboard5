<section id="anc_bo_basic">
    ...
    <div>
        ...
        <tr>
            ...
            <td colspan="2">
                <input type="text" name="bo_table" value="<?php echo $board['bo_table'] ?>" id="bo_table" <?php echo $required ?> <?php echo $readonly ?> class="<?php echo $readonly ?>" maxlength="20">
                <?php if ($w == '') { ?>
        ...
        <tr>
            <th scope="row"><label for="gr_id">그룹<strong>필수</strong></label></th>
            <td colspan="2">
        ...
        <tr>
            <th scope="row"><label for="bo_subject">게시판 제목<strong>필수</strong></label></th>
            <td colspan="2">
                <input type="text" name="bo_subject" value="<?php echo get_text($board['bo_subject']) ?>" id="bo_subject" required class="required" size="80" maxlength="120">
            </td>
        </tr>
        <tr>
            ...
            <td colspan="2">
                ...
                <input type="text" name="bo_mobile_subject" value="<?php echo get_text($board['bo_mobile_subject']) ?>" id="bo_mobile_subject" size="80" maxlength="120">
            </td>
        </tr>
        <tr>
