<section id="anc_scf_index">
    ...
    <?php echo $pg_anchor; ?>
        ...
        <p>
            ...
            <div class="ui-form-label">히트상품출력</div>
            <div class="ui-form-field"><label for="de_type1_list_use">출력</label>
                ...
                <input type="text" name="de_type1_img_height" value="<?php echo get_sanitize_input($default['de_type1_img_height']); ?>" id="de_type1_img_height" size="3"></div>
        </div>
                <div class="ui-form-row">
            <div class="ui-form-label">추천상품출력</div>
            <div class="ui-form-field"><label for="de_type2_list_use">출력</label>
                ...
                <input type="text" name="de_type2_img_height" value="<?php echo get_sanitize_input($default['de_type2_img_height']); ?>" id="de_type2_img_height" size="3"></div>
        </div>
                <div class="ui-form-row">
            <div class="ui-form-label">최신상품출력</div>
            <div class="ui-form-field"><label for="de_type3_list_use">출력</label>
                ...
                <input type="text" name="de_type3_img_height" value="<?php echo get_sanitize_input($default['de_type3_img_height']); ?>" id="de_type3_img_height" size="3"></div>
        </div>
                <div class="ui-form-row">
            <div class="ui-form-label">인기상품출력</div>
            <div class="ui-form-field"><label for="de_type4_list_use">출력</label>
                ...
                <input type="text" name="de_type4_img_height" value="<?php echo get_sanitize_input($default['de_type4_img_height']); ?>" id="de_type4_img_height" size="3"></div>
        </div>
                <div class="ui-form-row">
            <div class="ui-form-label">할인상품출력</div>
            <div class="ui-form-field"><label for="de_type5_list_use">출력</label>
                ...
                <input type="text" name="de_type5_img_height" value="<?php echo get_sanitize_input($default['de_type5_img_height']); ?>" id="de_type5_img_height" size="3"></div>
        </div>
