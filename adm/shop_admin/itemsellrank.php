...
<input type="text" name="fr_date" value="<?php echo $fr_date; ?>" id="fr_date" required class="required" size="8" maxlength="8"> 에서
<label for="to_date">종료일</label>
<input type="text" name="to_date" value="<?php echo $to_date; ?>" id="to_date" required class="required" size="8" maxlength="8"> 까지
...
<div>
    ...
    for ($i=0; $row=sql_fetch_array($result); $i++)
    {
        ...
        <tr class="<?php echo $bg; ?>">
            ...
            <td><?php echo $row['ct_status_1']; ?></td>
            <td><?php echo $row['ct_status_2']; ?></td>
            <td><?php echo $row['ct_status_3']; ?></td>
            <td><?php echo $row['ct_status_4']; ?></td>
            <td><?php echo $row['ct_status_5']; ?></td>
            <td><?php echo $row['ct_status_6']; ?></td>
            <td><?php echo $row['ct_status_7']; ?></td>
            <td><?php echo $row['ct_status_8']; ?></td>
            <td><?php echo $row['ct_status_9']; ?></td>
            <td><?php echo $row['ct_status_sum']; ?></td>
        </tr>
        <?php
    }
