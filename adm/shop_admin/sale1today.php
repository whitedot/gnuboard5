...
<div>
    ...
    ?>
        <tr>
            ...
            <td><?php echo $href; ?><?php echo $row['od_name']; ?></a></td>
            <td><?php echo number_format($row['orderprice']); ?></td>
            <td><?php echo number_format($row['couponprice']); ?></td>
            <td><?php echo number_format($receipt_bank); ?></td>
            <td><?php echo number_format($receipt_vbank); ?></td>
            <td><?php echo number_format($receipt_iche); ?></td>
            <td><?php echo number_format($receipt_card); ?></td>
            <td><?php echo number_format($receipt_easy); ?></td>
            <td><?php echo number_format($receipt_hp); ?></td>
    ...
    if ($i == 0) {
        echo '<tr><td colspan="13">자료가 없습니다</td></tr>';
    }
    ?>
    </tbody>
    <tfoot>
    <tr>
        ...
        <td><?php echo number_format($tot['receipt_easy']); ?></td>
