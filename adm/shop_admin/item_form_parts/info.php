    ...
    <div class="form-card table-shell">
        ...
        <tr>
            ...
            <td colspan="2">
                <?php if ($w == '') { // 추가 ?>
                    ...
                    <input type="text" name="it_id" value="<?php echo time(); ?>" id="it_id" required class="form-input required" size="20" maxlength="20">
                <?php } else { ?>
                    <input type="hidden" name="it_id" value="<?php echo $it['it_id']; ?>">
                    <span class="frm_ca_id"><?php echo $it['it_id']; ?></span>
                    <a href="<?php echo shop_item_url($it_id); ?>" class="btn-inline">상품확인</a>
                    <a href="<?php echo G5_ADMIN_URL; ?>/shop_admin/itemuselist.php?sfl=a.it_id&amp;stx=<?php echo $it_id; ?>" class="btn-inline">사용후기</a>
                    <a href="<?php echo G5_ADMIN_URL; ?>/shop_admin/itemqalist.php?sfl=a.it_id&amp;stx=<?php echo $it_id; ?>" class="btn-inline">상품문의</a>
                <?php } ?>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="2">
                ...
                <input type="text" name="it_name" value="<?php echo get_text(cut_str($it['it_name'], 250, "")); ?>" id="it_name" required class="form-input required" size="95">
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <input type="text" name="it_basic" value="<?php echo get_text(html_purifier($it['it_basic'])); ?>" id="it_basic" class="form-input" size="95">
            </td>
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="it_order" value="<?php echo $it['it_order']; ?>" id="it_order" class="form-input" size="12">
            </td>
            <td class="cell-grpset">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="it_maker" value="<?php echo get_text($it['it_maker']); ?>" id="it_maker" class="form-input" size="40">
            </td>
            <td class="cell-grpset">
        ...
        <tr>
            ...
            <td>
                <?php echo help("입력하지 않으면 상품상세페이지에 출력하지 않습니다."); ?>
                <input type="text" name="it_origin" value="<?php echo get_text($it['it_origin']); ?>" id="it_origin" class="form-input" size="40">
            </td>
            <td class="cell-grpset">
        ...
        <tr>
            ...
            <td>
                <?php echo help("입력하지 않으면 상품상세페이지에 출력하지 않습니다."); ?>
                <input type="text" name="it_brand" value="<?php echo get_text($it['it_brand']); ?>" id="it_brand" class="form-input" size="40">
            </td>
            <td class="cell-grpset">
        ...
        <tr>
            ...
            <td>
                <?php echo help("입력하지 않으면 상품상세페이지에 출력하지 않습니다."); ?>
                <input type="text" name="it_model" value="<?php echo get_text($it['it_model']); ?>" id="it_model" class="form-input" size="40">
            </td>
            <td class="cell-grpset">
        ...
        <tr>
            ...
            <td colspan="2">
                ...
                <input type="text" name="ec_mall_pid" value="<?php echo get_text($it['ec_mall_pid']); ?>" id="ec_mall_pid" class="form-input" size="20">
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="it_sell_email" value="<?php echo get_sanitize_input($it['it_sell_email']); ?>" id="it_sell_email" class="form-input" size="40">
            </td>
            <td class="cell-grpset">
