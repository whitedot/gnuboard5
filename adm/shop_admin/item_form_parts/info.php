    ...
    <?php echo $pg_anchor; ?>
        ...
        <tr>
            ...
            <td colspan="2">
                ...
                <input type="text" name="it_name" value="<?php echo get_text(cut_str($it['it_name'], 250, "")); ?>" id="it_name" required class="required" size="95">
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <input type="text" name="it_basic" value="<?php echo get_text(html_purifier($it['it_basic'])); ?>" id="it_basic" size="95">
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="it_order" value="<?php echo $it['it_order']; ?>" id="it_order" size="12">
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="it_maker" value="<?php echo get_text($it['it_maker']); ?>" id="it_maker" size="40">
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <?php echo help("입력하지 않으면 상품상세페이지에 출력하지 않습니다."); ?>
                <input type="text" name="it_origin" value="<?php echo get_text($it['it_origin']); ?>" id="it_origin" size="40">
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <?php echo help("입력하지 않으면 상품상세페이지에 출력하지 않습니다."); ?>
                <input type="text" name="it_brand" value="<?php echo get_text($it['it_brand']); ?>" id="it_brand" size="40">
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <?php echo help("입력하지 않으면 상품상세페이지에 출력하지 않습니다."); ?>
                <input type="text" name="it_model" value="<?php echo get_text($it['it_model']); ?>" id="it_model" size="40">
            </td>
            <td>
        ...
        <tr>
            ...
            <td colspan="2">
                ...
                <input type="text" name="ec_mall_pid" value="<?php echo get_text($it['ec_mall_pid']); ?>" id="ec_mall_pid" size="20">
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="it_sell_email" value="<?php echo get_sanitize_input($it['it_sell_email']); ?>" id="it_sell_email" size="40">
            </td>
            <td>
