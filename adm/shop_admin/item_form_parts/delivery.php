<section id="anc_sitfrm_sendcost">
    ...
    <?php echo $pg_anchor; ?>
        ...
        <p>쇼핑몰설정 &gt; 배송비유형 설정보다 <strong>개별상품 배송비설정이 우선</strong> 적용됩니다.</p>
            ...
            <div class="ui-form-label"><label for="it_sc_type">배송비 유형</label></div>
            <div class="ui-form-field">
            <div><?php echo help("배송비 유형을 선택하면 자동으로 항목이 변환됩니다."); ?>
            ...
            <div id="sc_grp"><input type="checkbox" name="chk_ca_it_sendcost" value="1" id="chk_ca_it_sendcost">
                    <label for="chk_ca_it_sendcost">분류적용</label>
                    <input type="checkbox" name="chk_all_it_sendcost" value="1" id="chk_all_it_sendcost">
                    <label for="chk_all_it_sendcost">전체적용</label></div>
        </div>
        </div>
                    <div class="ui-form-row" id="sc_con_method">
            <div class="ui-form-label"><label for="it_sc_method">배송비 결제</label></div>
            <div class="ui-form-field"><select name="it_sc_method" id="it_sc_method">
                    ...
                    <div class="ui-form-row" id="sc_con_basic">
            <div class="ui-form-label"><label for="it_sc_price">기본배송비</label></div>
            <div class="ui-form-field"><?php echo help("무료배송 이외의 설정에 적용되는 배송비 금액입니다."); ?>
                    <input type="text" name="it_sc_price" value="<?php echo $it['it_sc_price']; ?>" id="it_sc_price" size="8"> 원</div>
        </div>
                    <div class="ui-form-row" id="sc_con_minimum">
            <div class="ui-form-label"><label for="it_sc_minimum">배송비 상세조건</label></div>
            <div class="ui-form-field">주문금액 <input type="text" name="it_sc_minimum" value="<?php echo $it['it_sc_minimum']; ?>" id="it_sc_minimum" size="8"> 이상 무료 배송</div>
        </div>
                    <div class="ui-form-row" id="sc_con_qty">
            <div class="ui-form-label"><label for="it_sc_qty">배송비 상세조건</label></div>
            <div class="ui-form-field"><?php echo help("상품의 주문 수량에 따라 배송비가 부과됩니다. 예를 들어 기본배송비가 3,000원 수량을 3으로 설정했을 경우 상품의 주문수량이 5개이면 6,000원 배송비가 부과됩니다."); ?>
                    주문수량 <input type="text" name="it_sc_qty" value="<?php echo $it['it_sc_qty']; ?>" id="it_sc_qty" size="8"> 마다 배송비 부과</div>
        </div>
