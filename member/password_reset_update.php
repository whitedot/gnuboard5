...
$mb_check = sql_fetch_prepared("select * from {$g5['member_table']} where mb_id = :mb_id AND mb_dupinfo = :mb_dupinfo", array(
    'mb_id' => $mb_id,
...
sql_query_prepared("update {$g5['member_table']} set mb_password = :mb_password where mb_id = :mb_id AND mb_dupinfo = :mb_dupinfo", array(
