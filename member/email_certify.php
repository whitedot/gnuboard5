...
sql_query_prepared(" update {$g5['member_table']} set mb_email_certify2 = '' where mb_id = :mb_id ", array(
    'mb_id' => $mb_id,
));
...
if ($mb_md5)
{
    ...
    {
        sql_query_prepared(" update {$g5['member_table']} set mb_email_certify = :mb_email_certify where mb_id = :mb_id ", array(
